...
def map_speakers_to_doctor_patient(
    ...
    for speaker_id, texts in speaker_content.items():
        ...
        # Store scores
        speaker_scores[speaker_id] = {"doctor": doctor_score, "patient": patient_score}
    ...
    if len(speaker_scores) == 2:
        ...
        logger.info(
            f"Speaker mapping: {speaker1_id} -> {speaker_mapping[speaker1_id]} (doctor_score: {speaker1_doctor_score:.1f}), "
