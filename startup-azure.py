#!/usr/bin/env python3
"""
Azure-optimized startup script that forces OpenAI Whisper API usage.
This avoids the local Whisper dependency issues.
"""
...
logger.info(f"TRANSCRIPTION_SERVICE: {os.environ.get('TRANSCRIPTION_SERVICE', 'not set')}")
